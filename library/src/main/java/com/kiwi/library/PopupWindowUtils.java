...
public class PopupWindowUtils {
    ...
    public PopupWindowUtils(View anchor) {
        this.anchor = anchor;
    ...
    private void dimBackground(float bgDim, float bgAlpha) {
        WindowManager.LayoutParams lp = getActivityFromView(this.anchor).getWindow().getAttributes();
//        WindowManager.LayoutParams lp = ((Activity) this.anchor.getContext()).getWindow()
//                .getAttributes();
        lp.alpha = bgAlpha;
        lp.dimAmount = bgDim;
        getActivityFromView(this.anchor).getWindow().setAttributes(lp);
        getActivityFromView(this.anchor).getWindow().addFlags(WindowManager.LayoutParams.FLAG_DIM_BEHIND);
...
//        ((Activity) this.anchor.getContext()).getWindow().addFlags(WindowManager.LayoutParams.FLAG_DIM_BEHIND);
    ...
    private void dimBackgroundWithAnimation(final float from, final float to) {
        Activity activity = getActivityFromView(this.anchor);
        final Window window = activity.getWindow();
        activity.getWindow().setDimAmount(from);
...
//        ((Activity) this.anchor.getContext()).getWindow().addFlags(WindowManager.LayoutParams.FLAG_DIM_BEHIND);
    ...
    public void showLikePopDownRightMenu() {
        this.root.measure(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    public void showBottomWithAlpha() {
        ...
        Rect rect = new Rect();
        getActivityFromView(this.anchor).getWindow().getDecorView().getWindowVisibleDisplayFrame(rect);
        //((Activity) this.anchor.getContext()).getWindow().getDecorView().getWindowVisibleDisplayFrame(rect);
        int winHeight = getActivityFromView(this.anchor).getWindow().getDecorView().getHeight();
